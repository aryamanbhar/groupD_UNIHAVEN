...
class TestAccommodation(APITestCase):
    def setUp(self):
        ...
        self.accommodation = Accommodation.objects.create(property_id=1, property_name="HKUST Test Property", status="available")
...
class TestReservation(APITestCase):
    def setUp(self):
        self.client = APIClient()
        self.student = Student.objects.create(student_id="HKUST123", name="Test Student", contact="123456789")
        self.accommodation = Accommodation.objects.create(property_id=2, property_name="HKUST Property", status="available")
